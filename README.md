...
API desenvolvida para uma página de contratação de diaristas. Projeto realizado durante o workshop TreinaWeb Multi-Stack 2.0.


## <div id="funcionalidades">✨ Funcionalidades</div>

✔️ CRUD de diaristas\
✔️ Listagem de diaristas por cidade (via CEP)
